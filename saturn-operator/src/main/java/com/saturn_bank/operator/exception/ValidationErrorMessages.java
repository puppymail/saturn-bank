...
public class ValidationErrorMessages {
    ...
    public static final String EMPTY_BIRTH_DATE_ERROR_MSG = "Please enter your birth date.";
    ...
    public static final String INVALID_PASSWORD_SIZE_ERROR_MSG = "Password should be between 1 and 32 symbols.";
